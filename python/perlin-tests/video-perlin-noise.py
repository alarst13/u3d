...
def add_perlin_noise_to_frame(frame, frame_num, num_octaves, wavelength_x, wavelength_y, wavelength_t):
...
def process_video(input_video_path, output_video_path, num_octaves, wavelength_x, wavelength_y, wavelength_t):
    ...
    while True:
        ...
        noisy_frame = add_perlin_noise_to_frame(frame, frame_num, num_octaves, wavelength_x, wavelength_y, wavelength_t)
